...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20210905_ptjcomics_42e43e18f06dc0b42279_20210905163600_archive.zip';
    const ARCHIVE_SIZE       = '446330778';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '42e43e1-05163600';
    const SECONDARY_PACKAGE_HASH = '41690d8-05163600';
    const VERSION            = '4.0.4';
    ...
    public function run()
    {
        ...
        $this->log('==DUPLICATOR INSTALLER BOOTSTRAP v4.0.4==');
        $this->log('----------------------------------------------------');
